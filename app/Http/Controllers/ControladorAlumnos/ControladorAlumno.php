...
class ControladorAlumno extends Controller
{
    ...
    public function rellenarAnexoXV(Request $req)
    {
        ...
        $nombre_alumno = Auxiliar::getNombreAlumno($dni_alumno);
        $nombre_ciclo = Auxiliar::getNombreCicloAlumno($dni_alumno);
        $centro_estudios = Auxiliar::getCentroEstudiosYLocalidad($dni_alumno);
        $familia_profesional = Auxiliar::getDescripcionFamiliaProfesional($nombre_ciclo[0]->nombre_ciclo);
